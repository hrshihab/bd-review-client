...
import image1 from './../illustration.svg'
...
const SignUp = () => {
  ...
  <div class="flex flex-col  justify-center px-6 py-8 mx-auto max-w-screen-xl  lg:py-8 grid-cols-1 md:grid md:grid-cols-2">
