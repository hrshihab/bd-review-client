...
const ReviewCard = ({review,handleDelete}) => {
  ...
  return (
    <div className="items-center gap-5 bg-gray-50 rounded-lg shadow flex dark:bg-gray-800 dark:border-gray-700">
                <Link to="#">
                    <img className=" w-40 rounded-3xl sm:rounded-none sm:rounded-l-lg" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/bonnie-green.png" alt="Bonnie Avatar"/>
                </Link>
                <div className="p-3 w-4/5">
                    <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                        <Link to="#">{name}</Link>
                    </h3>
                    <span className="text-gray-500 dark:text-gray-400">Rating : {rating}</span>
                    <p className="mt-3 mb-2 font-light text-gray-500 dark:text-gray-400">{description.slice(0,50)}...</p>
